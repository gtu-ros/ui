...
const MAPBOX_TILES_PATH = `${location.origin}${location.pathname}/maps/offline/`;
...
export const OFFLINE_STYLE = {
  ...
  sources: {
    countries: {
      ...
      tiles: [MAPBOX_TILES_PATH + 'countries/{z}/{x}/{y}.pbf'],
      maxzoom: 6
    }
  },
  glyphs: MAPBOX_TILES_PATH + 'font/{fontstack}/{range}.pbf',
  layers: [
    {
      id: 'background',
      type: 'background',
